...
//@Slf4j
public class HubBot //extends TelegramLongPollingBot
{
//    private final BotScript script;
//
//    public HubBot(BotScript script) {
//        this.script = script;
//    }
//
//    @Override
...
//                SendMessage message = generateMessage(1, chat_id, user_first_name, user_last_name, user_id, message_text);
//                try {
...
//
//            Integer choosedOptionId = Integer.valueOf(update.getCallbackQuery().getData());
//            System.out.println(choosedOptionId);
//            SendMessage message = generateMessage(choosedOptionId, chat_id, user_first_name, user_last_name, user_id, message_text);
//            try {
//                execute(message); // Sending our message object to user
//            } catch (TelegramApiException e) {
//                e.printStackTrace();
...
//    }
//
//    private SendMessage generateMessage(Integer optionId, String chat_id, String user_first_name, String user_last_name, long user_id, String message_text) {
//        String messageText = script.getContentById(optionId);
//        SendMessage message = new SendMessage(chat_id, messageText);
//
//        InlineKeyboardMarkup inlineKeyboardMarkup = new InlineKeyboardMarkup();
//
//        int optionsCount =script.getOptionsById(optionId).size();
//        if (optionsCount<=4) {
//            List<InlineKeyboardButton> keyboard = new ArrayList<>();
//            for (ScriptRow button_option : script.getOptionsById(optionId)) {
//                InlineKeyboardButton button = InlineKeyboardButton.builder()
//                        .callbackData(String.valueOf(button_option.getId()))
//                        .text(button_option.getButtonText())
//                        .build();
//                keyboard.add(button);
//            }
